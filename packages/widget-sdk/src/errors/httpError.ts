import type { UnavailableRoutes } from '@leapswap/widget-types'
import type { ExtendedRequestInit } from '../types/request.js'
import { BaseError } from './baseError.js'
import { LeapSwapErrorCode } from './constants.js'
...
const statusCodeToErrorClassificationMap = new Map([
  [
    400,
    {
      ...
      code: LeapSwapErrorCode.ValidationError,
    },
  ],
  [404, { type: ErrorName.NotFoundError, code: LeapSwapErrorCode.NotFound }],
  [
    409,
    {
      type: ErrorName.SlippageError,
      code: LeapSwapErrorCode.SlippageError,
      message: ErrorMessage.SlippageError,
    },
  ],
  [
    500,
    { type: ErrorName.ServerError, code: LeapSwapErrorCode.InternalError },
  ],
])
...
const getErrorClassificationFromStatusCode = (code: number) =>
  statusCodeToErrorClassificationMap.get(code) ?? {
    ...
    code: LeapSwapErrorCode.InternalError,
  }
