...
import type { Action, FeeCost, LeapSwapStep, StepToolDetails } from './step.js'
...
export type GasRecommendationResponse = {
  ...
  serviceFee?: TokenBalance // LeapSwap fee for providing the service
...
export type RelayerQuoteResponse = RelayerResponse<LeapSwapStep>

export type RelayRequest = LeapSwapStep
