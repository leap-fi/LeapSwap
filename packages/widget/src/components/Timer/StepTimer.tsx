import type { LeapSwapStepExtended } from '@leapswap/widget-sdk'
...
const getFirstExecutionProcess = (step: LeapSwapStepExtended) =>
  step.execution?.process.at(0)

const getExecutionProcess = (step: LeapSwapStepExtended) =>
  step.execution?.process.at(-1)

const getStartTimestamp = (step: LeapSwapStepExtended) =>
