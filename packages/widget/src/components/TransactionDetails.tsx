...
export const TransactionDetails: React.FC<TransactionDetailsProps> = ({
  ...
  // Only consume normalized Route estimate fields (gasCosts / feeCosts)
  const { feeCosts, gasCostUSD, feeCostUSD, combinedFeesUSD } =
    getAccumulatedFeeCostsBreakdown(route)
  // Same-chain: network gas; bridge: protocol fee (or gas if that's all we have)
  const networkFeeUSD = isBradge
    ? feeCostUSD || gasCostUSD
    : gasCostUSD
