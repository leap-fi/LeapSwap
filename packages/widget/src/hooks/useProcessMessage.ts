...
import { LeapSwapErrorCode } from '@leapswap/widget-sdk'
...
export const useProcessMessage = (step?: LeapSwapStep, process?: Process) => {
...
> = {
  ...
  FAILED: {
    ...
    // UNKNOWN_ERROR:
    //   'An unexpected error occurred. Please seek assistance in the LeapSwap discord server.',
  },
  INVALID: {},
  NOT_FOUND: {},
}
